...
export default function NewSupervisors() {
  ...
  const handleAddNew = (e) => {
    ...
    if (
      ...
      getDocs(
        query(
          collection(database, "supervisors"),
          ...
          if (res.docs.length != 0) {
            ...
            createUserWithEmailAndPassword(
              ...
              .then((userData) => {
                ...
                setDoc(doc(database, "supervisors", userid), {
  ...
  return (
    <div>
      ...
      <div className="mx-auto items-center ">
        <h3 className="text-[#fefcc0] text-xl text-center">New Supervisors</h3>
